...
export default {
    ...
    setup() {
        ...
        const selectedTab = ref('myTrades');
    ...
    methods: {
        ...
        async searchTrades() {
                ...
                for (var trade of this.myTrades) {
                    if (trade.card_one_title.toLowerCase().includes(lowerCaseInput) || 
                    trade.card_one_type.toLowerCase().includes(lowerCaseInput) || 
                    trade.card_two_title.toLowerCase().includes(lowerCaseInput) || 
                    trade.card_two_type.toLowerCase().includes(lowerCaseInput) || 

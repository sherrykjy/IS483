...
export default {
  ...
  methods: {
    openInfoPopup(cardName, cardSet, cardDescription, cardImage) {
    ...
    <div class="card">
        <div class="container">
            ...
            <div class="buttonBlock">
                <button style="background-color: var(--text-highlight);"> Cancel </button>
                <button style="background-color: var(--blue);"> Confirm </button>
            </div>
        </div>
    </div>
